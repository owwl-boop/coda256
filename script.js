...
let MATERIAL_DB = {
    ...
    '下地材': [
        ...
        { name: 'ラワンベニヤ4mm', spec: '3*6', price: 1300 },
        { name: 'ラワンベニヤ4mm', spec: '4*8', price: 2400 },
        { name: 'ラワンベニヤ9mm', spec: '3*6', price: 2100 },
        { name: 'ラワンベニヤ9mm', spec: '4*8', price: 3700 },
        { name: 'ラワンランバー15mm', spec: '3*6', price: 2300 },
        { name: 'ラワンランバー15mm', spec: '4*8', price: 3800 },
        { name: 'ラワンランバー18mm', spec: '3*6', price: 2700 },
        { name: 'ラワンランバー18mm', spec: '4*8', price: 4100 },
        { name: 'ラワンランバー21mm', spec: '3*6', price: 3200 },
    ...
    '金物': [
        ...
        { name: 'スライドレール1セット', spec: 'H-350', price: 500 },
        { name: '配線孔キャップ', spec: 'S91B', price: 800 },
        { name: 'MDダボ柱', spec: '1820', price: 600 },
        { name: '面付シリンダー錠', spec: '22', price: 1300 },
        { name: '平丁番', spec: '102*89HL', price: 1000 },
        { name: '平丁番', spec: '102*89ブラック', price: 1500 },
        { name: '本締錠', spec: 'Goal HD-5', price: 6000 },
        { name: 'ドアクローザ', spec: 'PS-7002', price: 8000 },
        { name: '上吊2wayレール', spec: 'AFD,1820レール', price: 15000 },
    ],
    '外注費': [
        { name: '塗装費用 (㎡)', spec: 'クリアラッカー', price: 6000 },
        { name: 'ガラス', spec: '飛散防止シート貼900*900', price: 10000 }, 
    ]
};
